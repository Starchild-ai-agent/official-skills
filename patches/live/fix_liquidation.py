...
if __name__ == "__main__":
    ...
    test_input = {
        ...
        "exchanges": [
            {"exchange": "Hyperliquid", "long_liquidations_usd": 0,
                "short_liquidations_usd": 0, "total_liquidations_usd": 19309486.50},
            {"exchange": "Binance", "long_liquidations_usd": 0,
                "short_liquidations_usd": 0, "total_liquidations_usd": 11303323.10},
        ]
    }
    ...
    assert fixed2["analysis"]["dominant_side"] == "unknown", (
        f"Expected 'unknown', got "
        f"'{fixed2['analysis']['dominant_side']}'"
    )
