...
- `references/aesthetics.md` — palette + typography methodology, real-brand values, dark-surface tint guide
- `references/components.md` — nav, cards, tables, buttons, forms, hero, CTA patterns
- `references/animations.md` — motion timing and entrance strategies
- `references/charts.md` — Chart.js / ECharts setup, chart-type selection
